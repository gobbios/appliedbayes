...
textfoo <- function(upto) {
  ...
  if (upto > 0) mtext(c("W", "L", "W", "W", "W", "L", "W", "L", "W")[1:upto], at = seq(0.05, 0.95, length.out = 9)[1:upto], col = "black")
}
...
::: {.r-stack}
![](figures/globetoss-10.png){.fragment .fade-in-then-out data-fragment-index=1}

![](figures/globetoss-1.png){.fragment .fade-in-then-out data-fragment-index=2}

![](figures/globetoss-2.png){.fragment .fade-in-then-out data-fragment-index=3}

![](figures/globetoss-3.png){.fragment .fade-in-then-out data-fragment-index=4}

![](figures/globetoss-4.png){.fragment .fade-in-then-out data-fragment-index=5}

![](figures/globetoss-5.png){.fragment .fade-in-then-out data-fragment-index=6}

![](figures/globetoss-6.png){.fragment .fade-in-then-out data-fragment-index=7}

![](figures/globetoss-7.png){.fragment .fade-in-then-out data-fragment-index=8}

![](figures/globetoss-8.png){.fragment .fade-in-then-out data-fragment-index=9}

![](figures/globetoss-9.png){.fragment .fade-in-then-out data-fragment-index=10}
